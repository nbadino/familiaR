...
initial_val <- eventReactive(input$go, {
  ...
  if(nval==1){"a"} 
  else if (nval==2){return("ab")}
  else if(nval==3){return("abc")}
  else if(nval==4){return("abcd")}
  else {return("abcde")}
  a <- input$aa
  b <- input$bb
  c <- input$cc
...
renderPlot({
  ...
  d <- input$dd
  e <- input$ee
  if(initial_val()=="a"){ini <- c(a)}
  else if(initial_val()=="ab"){ini <- c(a,b)}
  else if(initial_val()=="abc"){ini <- c(a,b,c)}
  else if(initial_val()=="abcd"){ini <- c(a,b,c,d)}
  else{ini <- c(a,b,c,d,e)}
  print(ini)
